"""TradingAccount — independent per-account subunit (S-010 PR #1).
...
class TradingAccount:
    ...
    def place_order(self, order: OrderPackage, *, dry_run: bool = True) -> str:
        ...
        dry_run : bool
            When True (default) the order is simulated — no live exchange call.
        ...
        return route_order(self, order, dry_run=dry_run)
