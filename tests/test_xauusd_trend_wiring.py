...
def test_strategy_yaml_pins_sweep_params():
    ...
    # M21 E-2 batch 2: confirm_1 REPLACED the depth cell (both wf 5/6 on the
    # same gold data; confirm dominates IS net/dd + OOS dd, measured at the
    # 0.0 base — one lever per leg). Moves with the mgc sibling.
