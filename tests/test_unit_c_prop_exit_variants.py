"""Unit C — swap-robust prop EXIT variants (config + wiring).

Covers Phase 0: the config-only tightened-exit prop variants of
trend_donchian_sol / trend_donchian_eth, mirroring the validated
...
ONLY the variant config/routing/wiring tests, no exit-ladder cases.
"""
