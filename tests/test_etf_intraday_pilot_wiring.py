...
def test_yaml_entries_pin_validated_params():
    ...
    # 2 consecutive reviews of should_skip-grade entries (conf 0.04-0.15), all
    # losses — the pilot's original 0.0 pin is superseded by the floored value.
    assert slv["min_confidence"] == 0.3 and slv["shadow_model_ids"] == []
