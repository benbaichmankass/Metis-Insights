...
| **WS5** | Baseline models | 🔄 IN PROGRESS (S-AI-WS5-A + S-AI-WS5-B-PART-1 + PART-2 (PR 2A + PR 2B) + S-AI-WS5-C + S-AI-WS5-C-FU + S-AI-WS5-D done; E–F queued) | [ws5-baseline-models.md](docs/sprint-plans/ai-traders/ws5-baseline-models.md) |
