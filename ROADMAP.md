...
|---|---|---|---|
| **S-STRAT-IMPROVE-S7** | **Strategy Improvement Program — first net-positive complementary strategy (trend-follower) (2026-05-23).** Built `scripts/backtest_trend.py` (Donchian breakout + ATR stop + Chandelier trail). Net-of-fee on 3yr BTCUSDT 1h: **+22.5R full / +18.4 (2023) / +12.6 (2024)** — the FIRST clearly net-positive strategy (vwap/turtle/ict_scalp all failed net), fee-efficient by design (~0.056R/trade). **Complements ict_scalp by regime:** trend wins 2024 (where ict_scalp lost −16.4), ict_scalp wins 2025 (where trend lost ~−8.5) → a portfolio of the two is smoother than either (North Star validated). Caveats: single param set (robustness sweep pending), long-side carries edge (bull-market; no static short-disable), BTCUSDT-only. Also: ict_scalp model-gate REJECTED OOS (#1828/#1831). Tier-1. Doc: [`complementary-trend-strategy-2026-05-23.md`](docs/audits/complementary-trend-strategy-2026-05-23.md). | 🔄 In progress 2026-05-23 | M7/M8 |
| **S-STRAT-IMPROVE-S5** | **Strategy Improvement Program — cross-strategy inherent-edge audit + regime confirmation (2026-05-23).** Built `backtest_turtle_soup.py` (net-of-fee) and ran ict_scalp + turtle_soup net-of-fee on the trainer's 3yr BTCUSDT cache across 2023/2024/2025 year-slices. **Regime confirmation revised the verdict:** **ict_scalp has a DURABLE gross edge** (positive every year: +31/+29/+46R gross; net +2.1/−18.9/+4.2 — the 2024 net-negative is a fee/over-trading problem, not edge) → **keeper**. **turtle_soup did NOT hold** — gross negative in 2023 (−6) & 2024 (−14); its +11.4R in 2025 was a single-window regime artifact → rework/exit-investigate (caveat: simplified single-TP1 harness). vwap: no edge. **Only 1 of 3 has durable edge → creative new-strategy workstream is now central.** Tier-1. Audit: [`strategy-inherent-edge-2026-05-23.md`](docs/audits/strategy-inherent-edge-2026-05-23.md). Log: [`S-STRAT-IMPROVE-S5-2026-05-23.md`](docs/sprint-logs/S-STRAT-IMPROVE-S5-2026-05-23.md). | 🔄 In progress 2026-05-23 | M7/M8 |
| **S-STRAT-IMPROVE-S4-B** | **Strategy Improvement Program — net-of-fee selectivity sweeps + vwap verdict (2026-05-23).** Ran the threshold sweep (#1784, 8×14d/365d) + entry×SL param sweep (#1785, 12 configs × 3×14d/365d), net-of-fee. **Verdict: vwap has no inherent edge — tuning cannot fix it** (0/8 and 0/36 windows net-positive; best config −41.7R/14d; gross ~flat-to-negative over a regime-diverse year). Selectivity + fee-efficiency reduce but never reverse the bleed. Instrumented `backtest_ict_scalp.py` for net-of-fee. **Program pivoted (operator-directed) from tuning-vwap to edge-first**: S4-B-3 (vwap HTF edge filter), S5 (turtle_soup/ict_scalp inherent-edge audit), S6 (assessment + recommendation). Tier-1. Verdict: [`vwap-viability-verdict-2026-05-23.md`](docs/audits/vwap-viability-verdict-2026-05-23.md). Log: [`S-STRAT-IMPROVE-S4-B-2026-05-23.md`](docs/sprint-logs/S-STRAT-IMPROVE-S4-B-2026-05-23.md). | ✅ Done 2026-05-23 | M7/M8 |
