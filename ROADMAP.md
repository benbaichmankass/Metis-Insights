...
|---|---|---|---|
| **S-STRAT-IMPROVE-S5** | **Strategy Improvement Program — cross-strategy inherent-edge audit, first read (2026-05-23).** Built `backtest_turtle_soup.py` (net-of-fee; turtle_soup had no harness) and ran ict_scalp + turtle_soup net-of-fee on the trainer's 3yr BTCUSDT cache (12-month slice, Mar2025→Feb2026). **Both have genuine edge** (unlike vwap): ict_scalp 204 trades 53.4% WR **gross +45.6R / net +4.2R**; turtle_soup 60 trades 61.7% WR **gross +11.4R / net +1.3R**. Fees eat ~90% of gross (net thin) — but they survive because wider structure stops are fee-efficient (~0.18R/trade vs vwap's ~0.45R). **Two keepers + vwap to retire/rework.** Caveats: one recent window (regime confirmation pending), simplified single-TP harness (net = floor). Tier-1. Audit: [`strategy-inherent-edge-2026-05-23.md`](docs/audits/strategy-inherent-edge-2026-05-23.md). Log: [`S-STRAT-IMPROVE-S5-2026-05-23.md`](docs/sprint-logs/S-STRAT-IMPROVE-S5-2026-05-23.md). | 🔄 First read done 2026-05-23 | M7/M8 |
