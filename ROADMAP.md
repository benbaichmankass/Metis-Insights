...
| **WS7** | Deployment tiers | 🔄 IN PROGRESS (PART-1..PART-5 done — both production strategies now shadow-capable; PART-6 Coordinator-side resolution + model training queued) | [ws7-deployment-tiers.md](docs/sprint-plans/ai-traders/ws7-deployment-tiers.md) |
