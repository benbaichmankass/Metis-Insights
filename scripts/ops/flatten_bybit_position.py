...
def flatten(account_id: str, symbol: str, *, apply: bool,
...
def main(argv: Optional[list] = None) -> int:
    ...
    ap.add_argument("--reason", default="",
                    help="WHY this flatten is being done. Recorded on the journal row so the\n                          close is attributable as OPERATIONAL rather than a strategy exit.")
