...
_Generated 2026-09-21T11:08:37+00:00 · verdict **all_sources_read**_
...
- 🔔 **OI-20260829-E35-REVERSED-LEGS-ARE-A-TIER-3-PROPOSAL-SET-NOT-APPLIED** (open_items · 21d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-LIVE-WALLET-TRUTH-CANNOT-REPRODUCE-THE-LEDGER-WINDOW** (open_items · 21d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-RESEARCH-QUEUE-GPU-ROUTE-AND-SPEND-GATE-NEVER-EXERCISED** (open_items · 21d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-RESEARCH-QUEUE-INFEASIBLE-STATE-SHIPPED-BUT-NEVER-REACHED-LIVE** (open_items · 21d) — monitoring row 21d since last observation (cadence 14d)
...
- 🔔 **OI-20260831-SCOPE-OVERLAP-ATTRIBUTOR-MISREADS-A-SESSIONS-OWN-START** (open_items · 21d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-LOCAL-LLM-VERDICT-PENDING-A-DIFFERENT-SIZE-ARM** (open_items · 20d) — loud row — must be reported on every session
...
- 🔔 **OI-20260902-REAPER-SHIPPED-AND-THE-KILL-PROVED-A-PARTIAL-LOSS-NOT-A-CLEAN-ONE** (open_items · 19d) — loud row — must be reported on every session
...
- 🔔 **manager-queue-watch-never-ran-overdue** (manager_queue_watch · 18d) — armed 453.2h ago, on the order of 453 expected firings, and ZERO receipts have ever been committed. The Routine reports SUCCEEDED, so nothing else reads as wrong. This is NOT `it has not fired yet`. Only the Routine can clear it — a hand-written receipt would arm the freshness grading against a file nobody maintains and report a healthy watch forever. Decide: fire it and confirm it can write, fold the escalation into the manager tick (which HAS a persistent session with tools), or RECORD the decision to retire it together with what then grades the manager's inaction.
...
- 🔔 **OI-20260905-MI-128-SWEEP-WINDOW-REKEYED-AND-THE-PR-HOLDS-ON-A-BACKFILL-DECISION** (open_items · 16d) — loud row — must be reported on every session
...
- 🔔 **OI-20260901-SUNSET-PASS-SHIPPED-AND-NOTHING-HAS-BEEN-RETIRED** (open_items · 15d) — monitoring row 15d since last observation (cadence 7d)
...
- 🔔 **OI-20260902-API-REFERENCE-SPLIT-OUT-OF-CLAUDE-MD-AND-NOT-YET-FOUND-AT-USE** (open_items · 15d) — monitoring row 15d since last observation (cadence 7d)
...
- 🔔 **OI-20260902-DECISION-PROMPTS-MOVED-TO-CLAUDEBOT-AND-NO-TAP-HAS-LANDED-THERE** (open_items · 15d) — loud row — must be reported on every session
...
- 🔔 **OI-20260906-SCALP-EXIT-HEAD-ARTIFACT-IS-THE-SECOND-MISSING-HALF-NOT-THE-FIRST** (open_items · 14d) — monitoring row 14d since last observation (cadence 7d)
...
- 🔔 **OI-20260908-QLD-TQQQ-EXAMINED-LOCALLY-AND-THE-CI-FEED-PATH-HAS-NEVER-RUN** (open_items · 13d) — monitoring row 13d since last observation (cadence 7d)
...
- 🔔 **OI-20260910-EXIT-EVAL-NEAR-MISS-BAND-AND-RESTART-GAP-SHIPPED-AND-NEITHER-HAS-GRADED-A-LIVE-BOUNDARY** (open_items · 11d) — monitoring row 11d since last observation (cadence 7d)
...
- 🔔 **OI-20260910-F39-STRANDED-PACKAGE-LEGS-DETECTOR-BUILT-AND-THE-REATTACH-AWAITS-AN-OPERATOR-YES-NO** (open_items · 11d) — monitoring row 11d since last observation (cadence 3d)
...
- 🔔 **OI-20260910-WORKFLOW-PAGE-SHIPPED-AND-THE-OPERATOR-HAS-NOT-SEEN-IT-RENDER** (open_items · 11d) — monitoring row 11d since last observation (cadence 3d)
...
- 🔔 **OI-20260831-PER-ACCOUNT-ARBITRATION-SHIPPED-NOT-YET-ARMED-OR-EXERCISED** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260831-PROBE-READERS-SHIPPED-BUT-THE-ACTIONS-ONE-HAS-NEVER-RUN-FOR-REAL** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260901-ALPACA-SHARE-HOLD-CLASSIFIER-SHIPPED-NOT-YET-OBSERVED** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260902-PR-QUEUE-WATCHER-SHIPPED-AND-ITS-CRON-HAS-NEVER-FIRED** (open_items · 10d) — monitoring row 10d since last observation (cadence 2d)
...
- 🔔 **OI-20260903-CAPTURE-WATCH-PROVED-ITSELF-ON-DEMAND-AND-ITS-SCHEDULE-HAS-NEVER-SUCCEEDED** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260907-CLOSE-CONFIRM-RESCOPE-IS-HELD-AND-MI-140-MUST-NOT-BE-FIXED-BEFORE-IT** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260908-ALPACA-QUANTITY-COVERAGE-SHIPPED-AND-A-56-SHARE-NAKED-POSITION-IS-STANDING** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **OI-20260911-BLOCKED-LANE-WATCH-SHIPPED-AND-NO-LANE-HAS-BEEN-WOKEN-BY-IT** (open_items · 10d) — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 **#11912** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(m7): strategy review packets (auto)
- 🔔 **#11916** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#11919** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 **#11939** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 **#11943** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 **#11952** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): PR-queue watcher receipt (auto)
- 🔔 **#11953** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#11956** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(m28): valuation snapshots (auto)
- 🔔 **#11998** (unlanded_automation · 9d) — producer output opened a PR that has not landed
  - chore(ops): trainer capture-watch receipt (auto)
- 🔔 **OI-20260826-STRAY-OCA-SWEEP-SHIPPED-BUT-UNARMED** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260830-E35-GEOMETRY-SHIPPED-TO-9-LEGS-NOT-YET-LIVE-VERIFIED** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 **OI-20260831-PROP-RISK-GATE-ENFORCE-ARMED-BUT-HAS-NEVER-CAPPED** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260901-CONSTRAINT-READOUT-SHIPPED-AND-IT-REFUSES-NOBODY-HAS-ACTED-ON-THE-REFUSAL** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260901-CYCLE-PRIORITY-IS-RENDERED-BUT-NO-SESSION-HAS-ACTED-ON-IT** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260901-DECISION-ROUNDTRIP-SHIPPED-AND-NO-DECISION-HAS-EVER-MADE-THE-ROUND-TRIP** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260902-BYBIT-COVERAGE-BASIS-MERGED-WITH-ARMING-DELIBERATELY-HELD-FOR-A-SOAK** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260902-DECISION-DRAIN-ROUTINE-DOES-NOT-EXIST-AND-NOTHING-HAS-EVER-DRAINED** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 **OI-20260902-HOURLY-DIGEST-CARRIER-PREPARED-AND-HELD-FOR-A-TIER-2-OK** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 **OI-20260902-REPLAY-PREGATE-CANNOT-FINISH-BECAUSE-THE-TRAINER-IS-OUT-OF-MEMORY** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260903-CLOSE-WEDGE-LEDGER-MERGED-AND-HAS-NEVER-BEEN-OBSERVED-PRESENT-ON-THE-FLEET** (open_items · 9d) — loud row — must be reported on every session
...
- 🔔 **OI-20260906-ICT-SCALP-5M-DEMOTED-OFF-BYBIT2-AND-NOTHING-HAS-SEEN-IT-STOP** (open_items · 9d) — monitoring row 9d since last observation (cadence 1d)
...
- 🔔 **OI-20260906-ML2-CALIBRATION-PASSED-BUT-THE-SHARPNESS-RESULT-IS-AGAINST-THE-WRONG-BASELINE** (open_items · 9d) — monitoring row 9d since last observation (cadence 5d)
...
- 🔔 **OI-20260906-RESEARCH-THAT-SPECIFIES-WORK-IS-CARRIED-BY-NOTHING** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260908-A-HEDGE-BOOK-FLAT-READ-IS-CLOSING-LIVE-BYBIT-POSITIONS-AND-THE-FLAP-GUARD-CANNOT-SEE-IT** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 **OI-20260908-THE-REAL-MONEY-CLOSED-POPULATION-IS-447-NOT-15-AND-TWO-SURFACES-DISAGREE-ON-ITS-EXIT-LABELS** (open_items · 9d) — loud row — must be reported on every session
...
- 🔔 **OI-20260909-PROP-STATUS-REQUEST-TRIGGER-DEPLOYED-BUT-THE-SUPPRESSION-HAS-NEVER-BEEN-OBSERVED** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 **OI-20260909-THE-FULL-SYSTEM-AUDITS-TIER-2-AND-TIER-3-PROPOSALS-ARE-FILED-AND-CARRIED-BY-NOTHING** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260909-THE-ROLLBACK-REGISTRY-IS-COLLAPSED-AND-THE-ROLLBACK-HAS-NEVER-BEEN-EXERCISED** (open_items · 9d) — monitoring row 9d since last observation (cadence 7d)
...
- 🔔 **OI-20260911-THE-PROP-ACCOUNT-IS-STARVED-NOT-QUIET-AND-THE-UNBLOCK-IS-A-SEQUENCE-NOT-A-FIX** (open_items · 9d) — monitoring row 9d since last observation (cadence 1d)
...
- 🔔 **OI-20260911-TIER-2-APPROVED-SELF-LANDING-IS-BUILT-AND-NO-PR-HAS-LANDED-OR-BEEN-REFUSED-BY-IT** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 **OI-20260911-WEBAPP-AUTH-SECRET-MAP-LANDED-AND-HAS-CARRIED-NO-VALUE** (open_items · 9d) — loud row — must be reported on every session
...
- 🔔 **OI-20260912-THE-WINNER-SIZE-COLLAPSE-IS-AN-R-COLLAPSE-AND-ITS-MAGNITUDE-IS-NOT-ESTABLISHED** (open_items · 9d) — monitoring row 9d since last observation (cadence 7d)
...
- 🔔 **#12225** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): session-reaper observations (auto)
- 🔔 **#12228** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#12229** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 **#12230** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12231** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 **#12239** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12245** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12249** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12253** (unlanded_automation · 8d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **OI-20260826-MGC-JOURNAL-QTY-DIVERGENT-UNOWNED** (open_items · 8d) — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 **OI-20260831-ALPACA-LIVE-FIRST-REAL-MONEY-LEG-ROUTED-BUT-HAS-NEVER-TRADED** (open_items · 8d) — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 **OI-20260909-INTENT-REDUCE-LEG-RESIZE-SHIPPED-AND-NO-LEG-HAS-BEEN-OBSERVED-RESIZED** (open_items · 8d) — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 **OI-20260910-ALPACA-LIVE-OPTION-A-FOUR-LEGS-ADDED-TO-REAL-MONEY-AND-THE-ORDER-PATH-HAS-NEVER-BEEN-EXERCISED** (open_items · 8d) — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 **OI-20260910-IB-PER-PASS-BREAKER-ARMED-AND-HAS-SKIPPED-NOTHING** (open_items · 8d) — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 **OI-20260912-BYBIT-SYMBOL-DEDUPE-REPAIRED-AND-NO-FLEET-READ-HAS-BEEN-SEEN-WITHOUT-THE-DROP** (open_items · 8d) — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 **OI-20260913-A-BYBIT2-HEDGE-BOOK-IS-NEVER-FETCHED-AND-NO-SURFACE-IN-THIS-REPO-CAN-SAY-WHETHER-IT-IS-STILL-THERE** (open_items · 8d) — monitoring row 8d since last observation (cadence 1d)
...
- 🔔 **#12257** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12263** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12265** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#12268** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 **#12269** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 **#12276** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12279** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12284** (unlanded_automation · 7d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12289** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12295** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12297** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#12298** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 **#12299** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 **#12306** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12312** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12316** (unlanded_automation · 6d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12320** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12326** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12328** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#12330** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 **#12331** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 **#12337** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12343** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12353** (unlanded_automation · 5d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12356** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(m1): economic-calendar PIT snapshots (auto)
- 🔔 **#12357** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12358** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 **#12359** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): session-reaper observations (auto)
- 🔔 **#12360** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): trainer capture-watch receipt (auto)
- 🔔 **#12361** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): PR-queue watcher receipt (auto)
- 🔔 **#12362** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 **#12363** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 **#12385** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **#12451** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12456** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12459** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12466** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12469** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12474** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12477** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12484** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12486** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12489** (unlanded_automation · 4d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
...
- 🔔 **OI-20260906-ICT-SCALP-EXIT-HEAD-CONSUMER-SHIPPED-AND-CANNOT-SCORE-UNTIL-A-SCALP-HEAD-IS-PUBLISHED** (open_items · 4d) — loud row — must be reported on every session
  - MI-150 shipped the M20 exit-head consumer into `ict_scalp` (annotate-only, disarmed) -- the wiring MI-146 identified as the only passed-gate work blocked on missing code. ⚠️ IT CANNOT SCORE A SINGLE L
- 🔔 **OI-20260909-CLOSED-FLAT-INVARIANT-CAN-FINALLY-SPEAK-AND-HAS-NOT-YET-SPOKEN** (open_items · 4d) — monitoring row 4d since last observation (cadence 3d)
...
- 🔔 **OI-20260911-THE-DIRECTIONAL-LEGS-BROKE-ON-2026-08-30-AND-THE-CAUSE-IS-UNATTRIBUTED** (open_items · 4d) — monitoring row 4d since last observation (cadence 1d)
...
- 🔔 **OI-20260911-THE-TWO-DETECTORS-ARE-BUILT-AND-NEITHER-HAS-EVER-FIRED-ON-THE-FLEET** (open_items · 4d) — monitoring row 4d since last observation (cadence 3d)
...
- 🔔 **OI-20260912-MI280-SHIPPED-EIGHT-LANDING-AND-REGISTER-INSTRUMENTS-AND-MOST-HAVE-NEVER-BEEN-SEEN-WORKING** (open_items · 4d) — monitoring row 4d since last observation (cadence 3d)
...
- 🔔 **OI-20260917-THE-GENERATED-CONFLICT-RECOMPUTE-IS-PROVEN-IN-REPLAY-AND-HAS-NEVER-RUN-ON-A-RUNNER** (open_items · 4d) — loud row — must be reported on every session
...
- 🔔 **#12493** (unlanded_automation · 3d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12498** (unlanded_automation · 3d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12502** (unlanded_automation · 3d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12511** (unlanded_automation · 3d) — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 **#12529** (unlanded_automation · 3d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 **OI-20260902-CONSTRAINT-READOUT-CRON-SHIPPED-AND-HAS-NEVER-FIRED-ON-SCHEDULE** (open_items · 3d) — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 **OI-20260912-FANOUT-APPLY-PATH-REPAIRED-AND-STILL-HAS-NEVER-DISPATCHED** (open_items · 3d) — monitoring row 3d since last observation (cadence 2d)
...
- 🔔 **OI-20260918-THE-TARGET-GEOMETRY-PACKET-EXISTS-AND-ITS-THREE-DECISIONS-ARE-UNANSWERED** (open_items · 3d) — loud row — must be reported on every session
...
- 🔔 **#12584** (unlanded_automation · 2d) — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
...
- **strategy:fade_breakout_4h** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · fade_breakout_4h
- **strategy:fvg_range_15m** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · fvg_range_15m
- **strategy:htf_pullback_trend_2h** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · htf_pullback_trend_2h
- **strategy:ief_pullback_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · ief_pullback_1d
- **strategy:iwm_trend_long_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · iwm_trend_long_1d
- **strategy:mhg_pullback_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · mhg_pullback_1d
- **strategy:qld_trend_long_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · qld_trend_long_1d
- **strategy:qqq_trend_long_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · qqq_trend_long_1d
- **strategy:slv_pullback_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · slv_pullback_1d
- **strategy:slv_trend_1h** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · slv_trend_1h
- **strategy:tlt_pullback_1d** (sunset · 20d) — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · tlt_pullback_1d
- **OI-20260902-BYBIT-GRADED-COVERAGE-SOAK-IS-THE-ONLY-EVIDENCE-FOR-WIDENING-AND-NOTHING-WATCHES-IT** (soaks · 19d) — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: verdicts_differ=true. This is a KNOWN, DECLARED gap (`probe_absent_reason` says why) — it is NOT evidence the soak is empty, and it is not evidence it is accruing either. Nobody has looked.
  - #10746 ships a soak at runtime_logs/bybit_coverage_soak.jsonl whose rows are the ONLY declared evidence for the operator's conditional widening of the graded-coverage gate to bybit_portfolio and then 
- **OI-20260902-SUNSET-CANDIDATES-ARE-NOW-DUE-AND-NINE-ARE-UNDISPOSITIONED** (open_items · 15d) — monitoring row 15d since last observation (cadence 7d)
...
- **OI-20260911-THE-UNROUTED-ROW-DETECTOR-IS-SEEDED-AND-HAS-REPORTED-NOTHING** (open_items · 10d) — monitoring row 10d since last observation (cadence 2d)
...
- **ERRFEED-9da85381** (error_feed · 9d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 21 rows 2026-09-12T18:18:11 → 2026-09-18T04:51:30 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
...
- **ERRFEED-a46d2970** (error_feed · 9d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 23 rows 2026-09-12T18:12:44 → 2026-09-21T06:33:25 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
...
- **ERRFEED-fa77ad80** (error_feed · 9d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 24 rows 2026-09-12T18:12:44 → 2026-09-18T21:49:18 · symbols=MES — decide: fix now, or file to a backlog
...
- **OI-20260826-MHG-OVER-COVER-MECHANISM-UNVERIFIED** (open_items · 9d) — monitoring row 9d since last observation (cadence 2d)
...
- **OI-20260826-SESSION-BRIEF-NEVER-READ-BY-A-FRESH-SESSION** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- **OI-20260910-ORPHAN-ADOPT-SIZE-GATE-DEPLOYED-AND-HAS-REFUSED-NOTHING** (open_items · 9d) — monitoring row 9d since last observation (cadence 3d)
...
- **ERRFEED-ae533209** (error_feed · 8d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 9 rows 2026-09-13T14:15:14 → 2026-09-20T01:13:40 · accounts=bybit_1 symbols=AVAXUSDT — decide: fix now, or file to a backlog
...
- **ERRFEED-516a1b2a** (error_feed · 7d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 9 rows 2026-09-14T06:10:03 → 2026-09-20T16:11:13 · accounts=bybit_1 symbols=SOLUSDT — decide: fix now, or file to a backlog
...
- **ERRFEED-72e2ad1e** (error_feed · 7d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 70 rows 2026-09-14T10:02:36 → 2026-09-18T23:14:31 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
...
- **ERRFEED-22c7c0be** (error_feed · 5d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 14 rows 2026-09-16T19:29:11 → 2026-09-16T19:56:10 · accounts=ib_paper symbols=MES — decide: fix now, or file to a backlog
...
- **ERRFEED-5402e495** (error_feed · 5d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 47 rows 2026-09-16T23:54:03 → 2026-09-17T01:25:29 · accounts=ib_paper symbols=MES — decide: fix now, or file to a backlog
...
- **OI-20260909-POSITION-READ-STATE-SOAK-DECIDES-WHETHER-THE-COLLAPSED-READ-EVER-FIRES** (open_items · 4d) — monitoring row 4d since last observation (cadence 3d)
  - MI-222 Tier-2 (operator-approved observable-first, 2026-09-09) made the collapsed position read at src/units/accounts/clients.py COUNTABLE without changing what any caller receives: three venue answer
...
- **ERRFEED-b0711dd4** (error_feed · 0d) — error-level condition on `bot_logs`, FIRST SEEN since the last digest — 1 rows 2026-09-21T04:32:31 → 2026-09-21T04:32:31 · accounts=ib_paper — decide: fix now, or file to a backlog
  - [error] NEW x1 ib_stop_over_cover detected: ib_paper/MGC: position N but resting STOP qty totals N (N%) across N DISJOINT OCA groups oca-protect-tN(clientI
- **ERRFEED-bdd0b1d7** (error_feed · 0d) — error-level condition on `operator_alerts`, FIRST SEEN since the last digest — 1 rows 2026-09-21T05:11:15 → 2026-09-21T05:11:15 · symbols=MGC strategies=mgc_pullback_1d — decide: fix now, or file to a backlog
  - [error] NEW x1 🚨 Stuck-strategy watchdog Strategy: mgc_pullback_Nd | Symbol: MGC Package: pkg-<hex> DB trade id: N Stuck for: N min Action: force-cleared I
- **ERROR-FEED-SUMMARY** (error_feed) — 52 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-21T00:51:39.489827+00:00`.
  - 95 cause groups over 1405 rows (62 error-level, 33 warn-level, 2 new since the last digest)
