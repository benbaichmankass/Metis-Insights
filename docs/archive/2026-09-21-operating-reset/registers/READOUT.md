...
_Generated 2026-09-20T11:11:56+00:00 by `scripts/ops/constraint_readout.py` · cycle `CY-20260906-TRADING-TRUTH` (basis DECIDED)_
...
**Verdict: `computed`** — held-up stage **DECISION**

Coverage is 53.8% (113/210). The most held-up stage is **DECISION** (11 object(s) with a live hold).

| population | assessed | coverage | floor |
|---|---|---|---|
| 210 objects | 113 | **53.8%** | 50.0% |

**Edge basis, never collapsed** — `blocked` 34 · `declared_none` 79 · **`unstated` 96** · `malformed` 1.
...
Objects by stage: `QUESTION` 16 · `EVIDENCE` 37 · `DECISION` 19 · `DEPLOYMENT` 26 · `OBSERVATION` 7 · `CAPABILITY` 33 · `INTEGRITY` 43 · `(unstated)` 29

⚠️ **24 of 210 of those stages were assigned in BULK FROM THE SOURCE FILENAME, not by reading the row.** The Phase C migration maps `health-review-backlog.json` → `INTEGRITY` and `{ml,performance,research}-review-backlog.json` → `EVIDENCE`, with no per-row judgement, so `INTEGRITY 43` is a census of ONE filename. Only **183** stage(s) in the whole store were chosen per object — and choosing one is not a claim it is RIGHT, only that a filename did not decide it.

Stage by how the stage was arrived at: `bulk_by_source_file` → EVIDENCE 9, INTEGRITY 15 · `per_object` → (unstated) 26, CAPABILITY 33, DECISION 19, DEPLOYMENT 26, EVIDENCE 28, INTEGRITY 28, OBSERVATION 7, QUESTION 16 · `unstated` → (unstated) 3

**The assessed subgraph — every object that declares an edge (34 of 210):**
...
- **`WO-20260918-CAN-A-SCALP-CONTROL-BE-INDEPENDENT-AT-ALL`** (EVIDENCE · waiting) — Research lane: is a stronger control available for the scalp family at all, or is the weakness structural?
  - `operator_decision` → `DEC-20260918-BUILD-THE-UNDERDETERMINED-SCALP-CONTROL` · ref `not_in_store_by_design` · hold **`unverifiable_outside_store`** · since 2026-09-18
- **`WO-20260918-DOES-THE-ICT-SCALP-HARNESS-FEED-THE-LIVE-DECISION-LIVE-INPUTS`** (EVIDENCE · waiting) — Research lane: backtest_ict_scalp.py CALLS the live order_package -- does it hand that function the same window and the same config the live builder does?
  - `operator_decision` → `DEC-20260918-THE-ICT-SCALP-HARNESS-AND-THE-GATED-XRP-VARIANT` · ref `not_in_store_by_design` · hold **`unverifiable_outside_store`** · since 2026-09-18
- **`WO-20260918-IS-THE-FVG-HARNESS-A-VERBATIM-ENTRY-PORT`** (EVIDENCE · waiting) — Research lane: grade the fvg_range_15m verbatim-port claim -- is its harness a port of the live entry block, or a reimplementation?
  - `operator_decision` → `DEC-20260918-FVG-DECLARED-CANDLE-MINIMUM` · ref `not_in_store_by_design` · hold **`unverifiable_outside_store`** · since 2026-09-18
- **`WO-20260918-WHICH-HARNESSES-RUN-THE-LIVE-ENTRY-DECISION`** (EVIDENCE · waiting) — Research lane: which pre-live harnesses RUN the live entry decision, which REIMPLEMENT it, and which only CLAIM to -- and how many live legs sit behind each an…
  - `operator_decision` → `DEC-20260918-WHERE-TO-SPEND-THE-NEXT-HARNESS-ADJUDICATION` · ref `not_in_store_by_design` · hold **`unverifiable_outside_store`** · since 2026-09-18
- **`WO-20260918-WHICH-LEGS-ARE-STARVED-AND-HOW-OFTEN`** (EVIDENCE · waiting) — Research lane: measure which legs are starved, how often, and whether the per-account arbitration fan-out already covers them
  - `operator_decision` → `DEC-20260918-UNSTARVE-THE-PROP-LEGS-OR-RECORD-THAT-WE-WILL-NOT` · ref `not_in_store_by_design` · hold **`unverifiable_outside_store`** · since 2026-09-18
...
|---|---|---|---|---|
| 34 | 20.6% | -55.7372 | -55.7372 | **79.4%** |

Provenance split — measured 27 · estimated 7 · fabricated 0 · unverified 0.
...
**4 in flight against a ceiling of 8** (headroom 4) · 39 waiting.
...
In flight: `WO-20260912-UNBLOCK-THE-PROP-ACCOUNT-IT-IS-STARVED` · `WO-20260916-OPERATOR-DIRECTION` · `WO-20260918-DECISION-POPUPS-NEVER-ARRIVE-BECAUSE-EVERY-OVER-CAP-PROMPT-400S` · `WO-20260918-THE-PR-QUEUE-IS-65-PERCENT-BOT-NOISE`

Waiting: `WO-20260901-PHASE-A` · `WO-20260901-PHASE-C` · `WO-20260901-PHASE-D` · `WO-20260901-PHASE-F` · `WO-20260902-DECISION-REVIEW-PACKET-POPULATION` · `WO-20260902-EVIDENCE-TRADE-PRIORITISATION-AB` · `WO-20260903-CLOSE-WEDGE-LEDGER-ABSENT` · `WO-20260903-SUNSET-DISPOSITIONS-OWED` · `WO-20260903-THE-REFUSAL-HALF-OF-MANAGER-CONTROL-BLOCK` · `WO-20260904-MANAGER-IDLE-IS-UNBOUNDED-AND-NOTHING-WAKES-IT` · `WO-20260905-PENDING-PINGS-HAS-NO-MERGE-DRIVER-SO-PING-PRS-DIE` · `WO-20260906-ICT-SCALP-5M-TO-SHADOW-THEN-ESTABLISH` · `WO-20260906-ML-2-THE-PREDICTIVE-BRACKET` · `WO-20260906-NO-5M-OR-15M-SCALP-EXIT-HEAD` · `WO-20260906-SHIP-THE-EXIT-HEAD-INTO-ICT-SCALP-THREE-LEGS` · `WO-20260906-THE-EXIT-GEOMETRY-REBUILD-WAS-SPECIFIED-AND-NEVER-DISPATCHED` · `WO-20260907-CLOSE-CONFIRMATION-IS-SYMBOL-SCOPED` · `WO-20260908-COORDINATION-BOARD-IS-AT-GITHUB-S-2500` · `WO-20260908-RE-ARM-PROTECTION-FOR-THE-56-NAKED` · `WO-20260908-RECONCILE-THE-BYBIT-1-ETHUSDT-ORPHAN-TRADE` · `WO-20260908-TRADE-SCOPE-THE-ALPACA-CLOSE-OPERATION-AND` · `WO-20260908-WIRE-MORE-STRATEGIES-TO-ALPACA-LIVE-WHICH` · `WO-20260909-DECISION-CLOSED-FLAT-INVARIANT-CANNOT-SEE-A-FAILED-READ` · `WO-20260909-DECISION-INTENT-REDUCE-ORPHANS-A-PROTECTIVE-LEG` · `WO-20260909-GATE-API-BOT-DB-THE-MONEY-DB` · `WO-20260910-ROOT-CAUSE-THE-EXIT-EVAL-60S-BREACHES` · `WO-20260911-A-FILED-ROW-THAT-IS-NEVER-ROUTED` · `WO-20260911-LET-AN-APPROVED-TIER-2-PR-LAND` · `WO-20260911-MAKE-THE-DATA-EXPLORER-REACHABLE-LAND-THE` · `WO-20260912-DECIDE-THE-LOUD-FLAG-TRIAGE` · `WO-20260912-ENGINEERING-LANE-MAKE-THE-LANDING-AND-REGISTER` · `WO-20260912-M20-ACTIVE-TRADE-MANAGEMENT-HOLD-WINNERS-LONGER` · `WO-20260912-OPS-LANE-DRIVE-THE-HEALTH-BACKLOG-DOWN` · `WO-20260912-UNBLOCK-THE-MERGE-QUEUE-THE-R13-MERGE` · `WO-20260918-CAN-A-SCALP-CONTROL-BE-INDEPENDENT-AT-ALL` · `WO-20260918-DOES-THE-ICT-SCALP-HARNESS-FEED-THE-LIVE-DECISION-LIVE-INPUTS` · `WO-20260918-IS-THE-FVG-HARNESS-A-VERBATIM-ENTRY-PORT` · `WO-20260918-WHICH-HARNESSES-RUN-THE-LIVE-ENTRY-DECISION` · `WO-20260918-WHICH-LEGS-ARE-STARVED-AND-HOW-OFTEN`

**Stopped moving** (no declared movement in ≥14d):
- `WO-20260901-PHASE-C` (waiting) — 19d — Phase C — migration, the WIP ceiling, and the priority that reaches a session
- `WO-20260901-PHASE-D` (waiting) — 19d — Phase D — the constraint, computed rather than judged
- `WO-20260902-DECISION-REVIEW-PACKET-POPULATION` (waiting) — 18d — Which POPULATION does the M7 strategy-review gate decide on — real money, or real blended with paper?
- `WO-20260902-EVIDENCE-TRADE-PRIORITISATION-AB` (waiting) — 18d — Confidence-first is the LIVE ranking key for competing trades and has never been shown to pick the better trade — and the A/B that would settle it cannot be run
- `WO-20260903-CLOSE-WEDGE-LEDGER-ABSENT` (waiting) — 17d — The standing close-wedge ledger does not exist, and the digest that replaced the pager reads a non-canonical path for it -- so a downgraded wedge is in NEITHER…
- `WO-20260903-SUNSET-DISPOSITIONS-OWED` (waiting) — 17d — Ten evidenced retirement candidates have sat undispositioned since 2026-09-01, and retiring a leg is Tier-3 so only the operator can move them
- `WO-20260903-THE-REFUSAL-HALF-OF-MANAGER-CONTROL-BLOCK` (waiting) — 17d — The refusal half of manager control: block a manager action on a PR whose author session is still live
- `WO-20260904-MANAGER-IDLE-IS-UNBOUNDED-AND-NOTHING-WAKES-IT` (waiting) — 16d — a manager that stops acting is not detected by anything -- idle is unbounded, the lease expires into nobody, and the only thing that restarted work was the ope…
- `WO-20260905-PENDING-PINGS-HAS-NO-MERGE-DRIVER-SO-PING-PRS-DIE` (waiting) — 15d — docs/claude/pending-pings.jsonl is the ONE register with no row-aware merge driver, so every ping-carrying PR conflicts unresolvably and the only remaining pat…
- `WO-20260906-ML-2-THE-PREDICTIVE-BRACKET` (waiting) — 14d — ML-2, the predictive bracket: regress the exit location an entry should expect, graded on calibration first
- `WO-20260906-NO-5M-OR-15M-SCALP-EXIT-HEAD` (waiting) — 14d — No 5m or 15m scalp exit-head artifact exists — and the CONSUMER is missing too, so the artifact is the SECOND half, not the first
- `WO-20260906-SHIP-THE-EXIT-HEAD-INTO-ICT-SCALP-THREE-LEGS` (waiting) — 14d — Ship the M20 exit-head consumer into the ict_scalp unit (MI-146 recommendation #2) — wiring only, annotate-first, arming NOT taken
...
**From the work store: 19 `operator_decision` edge(s).**
...
- `WO-20260918-CAN-A-SCALP-CONTROL-BE-INDEPENDENT-AT-ALL` (EVIDENCE) → DEC-20260918-BUILD-THE-UNDERDETERMINED-SCALP-CONTROL · since 2026-09-18
- `WO-20260918-DOES-THE-ICT-SCALP-HARNESS-FEED-THE-LIVE-DECISION-LIVE-INPUTS` (EVIDENCE) → DEC-20260918-THE-ICT-SCALP-HARNESS-AND-THE-GATED-XRP-VARIANT · since 2026-09-18
- `WO-20260918-IS-THE-FVG-HARNESS-A-VERBATIM-ENTRY-PORT` (EVIDENCE) → DEC-20260918-FVG-DECLARED-CANDLE-MINIMUM · since 2026-09-18
- `WO-20260918-WHICH-HARNESSES-RUN-THE-LIVE-ENTRY-DECISION` (EVIDENCE) → DEC-20260918-WHERE-TO-SPEND-THE-NEXT-HARNESS-ADJUDICATION · since 2026-09-18
- `WO-20260918-WHICH-LEGS-ARE-STARVED-AND-HOW-OFTEN` (EVIDENCE) → DEC-20260918-UNSTARVE-THE-PROP-LEGS-OR-RECORD-THAT-WE-WILL-NOT · since 2026-09-18

⚠️ Zero here does NOT mean no decision is pending — it means no object DECLARES one, and 96 of 210 objects have never been assessed for edges at all.
...
**Completeness: `all_sources_read`** · **210 row(s) due** across the sources that answered and are not already covered above (via `scripts/ops/render_due_list.py`).
...
| `probes` | `read` | 8 | freshness=fresh age=1.3h cadence=daily (cron 20 5 * * *) \| 4 probe result(s) deferred to the `soaks` source,… |
| `red_crons` | `read` | 2 |  |
| `red_main_runs` | `read` | 0 | 7 workflow(s) graded, 0 red · 7 graded at `main`'s tip · none graded behind the tip · 0 with distance_unknown… |
...
| `unlanded_automation` | `read` | 68 |  |
| `error_feed` | `read` | 11 | digest 2026-09-20T10:04:44+00:00, age 1.1h |
| `sunset` | `read` | 12 |  |
| `checklist_unrouted` | `read` | 5 | register_freshness=fresh |
| `stuck_branches` | `read` | 1 | 249 branch(es) standing |
| `settled_disposition_owed` | `read` | 0 | settled record grades settled_graded (118 settled row(s)) |
| `spent_decision_edges` | `read` | 11 | 210 object(s) read, 0 unparseable; 19 reported edge(s): 17 spent, 2 unresolvable; 11 on a `waiting` object |
...
- 🔔 `OI-20260906-RESEARCH-THAT-SPECIFIES-WORK-IS-CARRIED-BY-NOTHING` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260902-BYBIT-GRADED-COVERAGE-SOAK-IS-THE-ONLY-EVIDENCE-FOR-WIDENING-AND-NOTHING-WATCHES-IT` · 3d — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-OPERATING-LAYER-BUILD-IS-IN-FLIGHT-AND-CARRIED-ONLY-BY-THIS-ROW` · 8d — monitoring row 8d since last observation (cadence 1d)
...
- `OI-20260826-MHG-OVER-COVER-MECHANISM-UNVERIFIED` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- `OI-20260826-SESSION-BRIEF-NEVER-READ-BY-A-FRESH-SESSION` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260826-STRAY-OCA-SWEEP-SHIPPED-BUT-UNARMED` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260826-MGC-JOURNAL-QTY-DIVERGENT-UNOWNED` · 7d — monitoring row 7d since last observation (cadence 2d)
...
- 🔔 `OI-20260903-CAPTURE-WATCH-PROVED-ITSELF-ON-DEMAND-AND-ITS-SCHEDULE-HAS-NEVER-SUCCEEDED` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260829-ALPACA-GOLIVE-BLOCKED-ON-T1-SETTLEMENT-MODEL` · 20d — loud row — must be reported on every session
...
- 🔔 `OI-20260830-E35-GEOMETRY-SHIPPED-TO-9-LEGS-NOT-YET-LIVE-VERIFIED` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 `OI-20260829-E35-REVERSED-LEGS-ARE-A-TIER-3-PROPOSAL-SET-NOT-APPLIED` · 20d — loud row — must be reported on every session
...
- 🔔 `OI-20260831-PER-ACCOUNT-ARBITRATION-SHIPPED-NOT-YET-ARMED-OR-EXERCISED` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260831-PROP-RISK-GATE-ENFORCE-ARMED-BUT-HAS-NEVER-CAPPED` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260831-LIVE-WALLET-TRUTH-CANNOT-REPRODUCE-THE-LEDGER-WINDOW` · 20d — loud row — must be reported on every session
...
- 🔔 `OI-20260831-RESEARCH-QUEUE-INFEASIBLE-STATE-SHIPPED-BUT-NEVER-REACHED-LIVE` · 20d — monitoring row 20d since last observation (cadence 14d)
...
- 🔔 `OI-20260831-RESEARCH-QUEUE-GPU-ROUTE-AND-SPEND-GATE-NEVER-EXERCISED` · 20d — loud row — must be reported on every session
...
- 🔔 `OI-20260831-SCOPE-OVERLAP-ATTRIBUTOR-MISREADS-A-SESSIONS-OWN-START` · 20d — loud row — must be reported on every session
...
- 🔔 `OI-20260831-LOCAL-LLM-VERDICT-PENDING-A-DIFFERENT-SIZE-ARM` · 19d — loud row — must be reported on every session
...
- 🔔 `OI-20260831-PROBE-READERS-SHIPPED-BUT-THE-ACTIONS-ONE-HAS-NEVER-RUN-FOR-REAL` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260831-ALPACA-LIVE-FIRST-REAL-MONEY-LEG-ROUTED-BUT-HAS-NEVER-TRADED` · 7d — monitoring row 7d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-CYCLE-PRIORITY-IS-RENDERED-BUT-NO-SESSION-HAS-ACTED-ON-IT` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-CONSTRAINT-READOUT-SHIPPED-AND-IT-REFUSES-NOBODY-HAS-ACTED-ON-THE-REFUSAL` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-ALPACA-SHARE-HOLD-CLASSIFIER-SHIPPED-NOT-YET-OBSERVED` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-DECISION-ROUNDTRIP-SHIPPED-AND-NO-DECISION-HAS-EVER-MADE-THE-ROUND-TRIP` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260901-SUNSET-PASS-SHIPPED-AND-NOTHING-HAS-BEEN-RETIRED` · 14d — monitoring row 14d since last observation (cadence 7d)
...
- 🔔 `OI-20260901-CLAUDE-CHANNEL-SEPARATION-SHIPPED-BUT-UNPROVEN` · 8d — monitoring row 8d since last observation (cadence 1d)
...
- 🔔 `OI-20260902-TELEGRAM-DECISION-ROUNDTRIP-SHIPPED-AND-NO-TAP-HAS-EVER-BEEN-MADE` · 14d — loud row — must be reported on every session
...
- 🔔 `OI-20260902-BYBIT-COVERAGE-BASIS-MERGED-WITH-ARMING-DELIBERATELY-HELD-FOR-A-SOAK` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260902-DECISION-PROMPTS-MOVED-TO-CLAUDEBOT-AND-NO-TAP-HAS-LANDED-THERE` · 14d — loud row — must be reported on every session
...
- 🔔 `OI-20260902-CONSTRAINT-READOUT-CRON-SHIPPED-AND-HAS-NEVER-FIRED-ON-SCHEDULE` · 2d — loud row — must be reported on every session
...
- `OI-20260902-ROLE-PACKS-NOW-REACH-THE-OPERATING-LAYER-AND-NO-SESSION-HAS-BEEN-OBSERVED-USING-IT` · 8d — monitoring row 8d since last observation (cadence 7d)
...
- `OI-20260902-SUNSET-CANDIDATES-ARE-NOW-DUE-AND-NINE-ARE-UNDISPOSITIONED` · 14d — monitoring row 14d since last observation (cadence 7d)
...
- 🔔 `OI-20260902-REPLAY-PREGATE-CANNOT-FINISH-BECAUSE-THE-TRAINER-IS-OUT-OF-MEMORY` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260902-REAPER-SHIPPED-AND-THE-KILL-PROVED-A-PARTIAL-LOSS-NOT-A-CLEAN-ONE` · 18d — loud row — must be reported on every session
...
- 🔔 `OI-20260902-DECISION-DRAIN-ROUTINE-DOES-NOT-EXIST-AND-NOTHING-HAS-EVER-DRAINED` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 `OI-20260902-API-REFERENCE-SPLIT-OUT-OF-CLAUDE-MD-AND-NOT-YET-FOUND-AT-USE` · 14d — monitoring row 14d since last observation (cadence 7d)
...
- 🔔 `OI-20260902-PR-QUEUE-WATCHER-SHIPPED-AND-ITS-CRON-HAS-NEVER-FIRED` · 9d — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 `OI-20260902-HOURLY-DIGEST-CARRIER-PREPARED-AND-HELD-FOR-A-TIER-2-OK` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 `OI-20260903-OPERATOR-COMMANDS-MOVED-OFF-THE-TRADER-BOT-PREPARED-AND-HELD` · 17d — monitoring row 17d since last observation (cadence 2d)
...
- 🔔 `OI-20260903-CLOSE-WEDGE-LEDGER-MERGED-AND-HAS-NEVER-BEEN-OBSERVED-PRESENT-ON-THE-FLEET` · 8d — loud row — must be reported on every session
...
- 🔔 `OI-20260904-MANAGER-WAKE-BUILT-AND-ITS-SCHEDULER-DOES-NOT-EXIST` · 15d — loud row — must be reported on every session
...
- 🔔 `OI-20260905-MI-128-SWEEP-WINDOW-REKEYED-AND-THE-PR-HOLDS-ON-A-BACKFILL-DECISION` · 15d — loud row — must be reported on every session
...
- 🔔 `OI-20260906-ICT-SCALP-5M-DEMOTED-OFF-BYBIT2-AND-NOTHING-HAS-SEEN-IT-STOP` · 8d — monitoring row 8d since last observation (cadence 1d)
...
- 🔔 `OI-20260906-THE-BRACKET-CALIBRATION-INSTRUMENT-EXISTS-AND-ITS-VERDICT-HAS-NOT-BEEN-ACTED-ON` · 14d — monitoring row 14d since last observation (cadence 7d)
...
- 🔔 `OI-20260906-SCALP-EXIT-HEAD-ARTIFACT-IS-THE-SECOND-MISSING-HALF-NOT-THE-FIRST` · 13d — monitoring row 13d since last observation (cadence 7d)
...
- 🔔 `OI-20260906-ICT-SCALP-EXIT-HEAD-CONSUMER-SHIPPED-AND-CANNOT-SCORE-UNTIL-A-SCALP-HEAD-IS-PUBLISHED` · 3d — loud row — must be reported on every session
...
- 🔔 `OI-20260906-ML2-CALIBRATION-PASSED-BUT-THE-SHARPNESS-RESULT-IS-AGAINST-THE-WRONG-BASELINE` · 8d — monitoring row 8d since last observation (cadence 5d)
...
- 🔔 `OI-20260907-CLOSE-CONFIRM-RESCOPE-IS-HELD-AND-MI-140-MUST-NOT-BE-FIXED-BEFORE-IT` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260908-ALPACA-QUANTITY-COVERAGE-SHIPPED-AND-A-56-SHARE-NAKED-POSITION-IS-STANDING` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260908-A-HEDGE-BOOK-FLAT-READ-IS-CLOSING-LIVE-BYBIT-POSITIONS-AND-THE-FLAP-GUARD-CANNOT-SEE-IT` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 `OI-20260908-QLD-TQQQ-EXAMINED-LOCALLY-AND-THE-CI-FEED-PATH-HAS-NEVER-RUN` · 12d — monitoring row 12d since last observation (cadence 7d)
...
- 🔔 `OI-20260908-THE-REAL-MONEY-CLOSED-POPULATION-IS-447-NOT-15-AND-TWO-SURFACES-DISAGREE-ON-ITS-EXIT-LABELS` · 8d — loud row — must be reported on every session
...
- 🔔 `OI-20260909-PROP-STATUS-REQUEST-TRIGGER-DEPLOYED-BUT-THE-SUPPRESSION-HAS-NEVER-BEEN-OBSERVED` · 8d — monitoring row 8d since last observation (cadence 2d)
...
- 🔔 `OI-20260909-THE-FULL-SYSTEM-AUDITS-TIER-2-AND-TIER-3-PROPOSALS-ARE-FILED-AND-CARRIED-BY-NOTHING` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- `OI-20260909-POSITION-READ-STATE-SOAK-DECIDES-WHETHER-THE-COLLAPSED-READ-EVER-FIRES` · 3d — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 `OI-20260909-CLOSED-FLAT-INVARIANT-CAN-FINALLY-SPEAK-AND-HAS-NOT-YET-SPOKEN` · 3d — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 `OI-20260909-INTENT-REDUCE-LEG-RESIZE-SHIPPED-AND-NO-LEG-HAS-BEEN-OBSERVED-RESIZED` · 7d — monitoring row 7d since last observation (cadence 3d)
...
- 🔔 `OI-20260909-THE-ROLLBACK-REGISTRY-IS-COLLAPSED-AND-THE-ROLLBACK-HAS-NEVER-BEEN-EXERCISED` · 8d — monitoring row 8d since last observation (cadence 7d)
...
- 🔔 `OI-20260910-EXIT-EVAL-NEAR-MISS-BAND-AND-RESTART-GAP-SHIPPED-AND-NEITHER-HAS-GRADED-A-LIVE-BOUNDARY` · 10d — monitoring row 10d since last observation (cadence 7d)
...
- 🔔 `OI-20260910-F39-STRANDED-PACKAGE-LEGS-DETECTOR-BUILT-AND-THE-REATTACH-AWAITS-AN-OPERATOR-YES-NO` · 10d — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 `OI-20260910-WORKFLOW-PAGE-SHIPPED-AND-THE-OPERATOR-HAS-NOT-SEEN-IT-RENDER` · 10d — monitoring row 10d since last observation (cadence 3d)
...
- 🔔 `OI-20260910-ALPACA-LIVE-OPTION-A-FOUR-LEGS-ADDED-TO-REAL-MONEY-AND-THE-ORDER-PATH-HAS-NEVER-BEEN-EXERCISED` · 7d — monitoring row 7d since last observation (cadence 3d)
...
- `OI-20260910-ORPHAN-ADOPT-SIZE-GATE-DEPLOYED-AND-HAS-REFUSED-NOTHING` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- `OI-20260911-THE-UNROUTED-ROW-DETECTOR-IS-SEEDED-AND-HAS-REPORTED-NOTHING` · 9d — monitoring row 9d since last observation (cadence 2d)
...
- 🔔 `OI-20260911-BLOCKED-LANE-WATCH-SHIPPED-AND-NO-LANE-HAS-BEEN-WOKEN-BY-IT` · 9d — monitoring row 9d since last observation (cadence 3d)
...
- 🔔 `OI-20260911-WEBAPP-AUTH-SECRET-MAP-LANDED-AND-HAS-CARRIED-NO-VALUE` · 8d — loud row — must be reported on every session
...
- 🔔 `OI-20260911-THE-DIRECTIONAL-LEGS-BROKE-ON-2026-08-30-AND-THE-CAUSE-IS-UNATTRIBUTED` · 3d — monitoring row 3d since last observation (cadence 1d)
...
- 🔔 `OI-20260911-THE-PROP-ACCOUNT-IS-STARVED-NOT-QUIET-AND-THE-UNBLOCK-IS-A-SEQUENCE-NOT-A-FIX` · 8d — monitoring row 8d since last observation (cadence 1d)
...
- 🔔 `OI-20260911-THE-TWO-DETECTORS-ARE-BUILT-AND-NEITHER-HAS-EVER-FIRED-ON-THE-FLEET` · 3d — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 `OI-20260912-THE-WINNER-SIZE-COLLAPSE-IS-AN-R-COLLAPSE-AND-ITS-MAGNITUDE-IS-NOT-ESTABLISHED` · 8d — monitoring row 8d since last observation (cadence 7d)
...
- 🔔 `OI-20260911-TIER-2-APPROVED-SELF-LANDING-IS-BUILT-AND-NO-PR-HAS-LANDED-OR-BEEN-REFUSED-BY-IT` · 8d — monitoring row 8d since last observation (cadence 3d)
...
- 🔔 `OI-20260910-IB-PER-PASS-BREAKER-ARMED-AND-HAS-SKIPPED-NOTHING` · 7d — monitoring row 7d since last observation (cadence 2d)
...
- 🔔 `OI-20260912-MI280-SHIPPED-EIGHT-LANDING-AND-REGISTER-INSTRUMENTS-AND-MOST-HAVE-NEVER-BEEN-SEEN-WORKING` · 3d — monitoring row 3d since last observation (cadence 3d)
...
- 🔔 `OI-20260912-FANOUT-APPLY-PATH-REPAIRED-AND-STILL-HAS-NEVER-DISPATCHED` · 2d — monitoring row 2d since last observation (cadence 2d)
...
- 🔔 `OI-20260912-BYBIT-SYMBOL-DEDUPE-REPAIRED-AND-NO-FLEET-READ-HAS-BEEN-SEEN-WITHOUT-THE-DROP` · 7d — monitoring row 7d since last observation (cadence 2d)
...
- 🔔 `OI-20260913-A-BYBIT2-HEDGE-BOOK-IS-NEVER-FETCHED-AND-NO-SURFACE-IN-THIS-REPO-CAN-SAY-WHETHER-IT-IS-STILL-THERE` · 7d — monitoring row 7d since last observation (cadence 1d)
...
- `OI-20260913-THE-DEFAULT-BRANCH-RED-READER-IS-DEPLOYED-AND-HAS-NEVER-QUERIED-THE-ACTIONS-API` · 3d — monitoring row 3d since last observation (cadence 3d)
  - scripts/ops/render_due_list.py gained `src_red_main_runs` (MI-280 U90 lane, PR #12209, merged 4f3e0c388): the latest COMPLETED push-to-`main` run of each workflow whose conclusion…
- 🔔 `OI-20260917-THE-GENERATED-CONFLICT-RECOMPUTE-IS-PROVEN-IN-REPLAY-AND-HAS-NEVER-RUN-ON-A-RUNNER` · 3d — loud row — must be reported on every session
...
- 🔔 `OI-20260918-THE-TARGET-GEOMETRY-PACKET-EXISTS-AND-ITS-THREE-DECISIONS-ARE-UNANSWERED` · 2d — loud row — must be reported on every session
...
- 🔔 `OI-20260918-THE-DECISION-CHANNEL-IS-REPAIRED-AND-NO-PROMPT-HAS-BEEN-OBSERVED-ARRIVING` — loud row — must be reported on every session
  - MI-303. THE CAUSE OF THE DEAD DECISION CHANNEL IS FOUND, MEASURED AND REPAIRED, AND NOT ONE PROMPT HAS BEEN OBSERVED ARRIVING SINCE -- those are different facts and only the first…

**`soaks` — 4 due**

- `OI-20260902-BYBIT-GRADED-COVERAGE-SOAK-IS-THE-ONLY-EVIDENCE-FOR-WIDENING-AND-NOTHING-WATCHES-IT` · 18d — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: verdicts_differ=true. This is a KNOWN, DECLARED g…
  - #10746 ships a soak at runtime_logs/bybit_coverage_soak.jsonl whose rows are the ONLY declared evidence for the operator's conditional widening of the graded-coverage gate to bybi…
- 🔔 `OI-20260906-ICT-SCALP-EXIT-HEAD-CONSUMER-SHIPPED-AND-CANNOT-SCORE-UNTIL-A-SCALP-HEAD-IS-PUBLISHED` · 14d — soak READY — ✅ READY — 95 matching row(s) of 1000 scanned satisfy the declared criterion (decision_state!=not_scored). ⚠️ Ready is not CLEA…
  - MI-150 shipped the M20 exit-head consumer into `ict_scalp` (annotate-only, disarmed) -- the wiring MI-146 identified as the only passed-gate work blocked on missing code. ⚠️ IT CA…
- `OI-20260909-POSITION-READ-STATE-SOAK-DECIDES-WHETHER-THE-COLLAPSED-READ-EVER-FIRES` · 11d — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: dropped_symbol_dedupe_count>=1. This is a KNOWN,…
  - MI-222 Tier-2 (operator-approved observable-first, 2026-09-09) made the collapsed position read at src/units/accounts/clients.py COUNTABLE without changing what any caller receive…
- `OI-20260909-CLOSED-FLAT-INVARIANT-CAN-FINALLY-SPEAK-AND-HAS-NOT-YET-SPOKEN` · 11d — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: examined>=1. This is a KNOWN, DECLARED gap (`prob…
  - The closed->exchange-flat invariant -- THE ONE MECHANISM that can independently contradict 'this trade is closed' -- was silent for four independent reasons, each alone sufficient…
...
**`unlanded_automation` — 68 due**

- 🔔 `#12625` · 0d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12584` · 1d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12529` · 2d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12511` · 2d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12502` · 2d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12498` · 2d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12493` · 2d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12489` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12486` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12484` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12477` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12474` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12469` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12466` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12459` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12456` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12451` · 3d — producer output opened a PR that has not landed
  - chore(ops): reconcile OPEN-PRS.json after merge (auto)
- 🔔 `#12385` · 3d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12363` · 3d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12362` · 3d — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 `#12361` · 3d — producer output opened a PR that has not landed
  - chore(ops): PR-queue watcher receipt (auto)
- 🔔 `#12360` · 3d — producer output opened a PR that has not landed
  - chore(ops): trainer capture-watch receipt (auto)
- 🔔 `#12359` · 3d — producer output opened a PR that has not landed
  - chore(ops): session-reaper observations (auto)
- 🔔 `#12358` · 3d — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 `#12357` · 3d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12356` · 3d — producer output opened a PR that has not landed
  - chore(m1): economic-calendar PIT snapshots (auto)
- 🔔 `#12353` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12343` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12337` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12331` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 `#12330` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 `#12328` · 4d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12326` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12320` · 4d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12316` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12312` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12306` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12299` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 `#12298` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 `#12297` · 5d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12295` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12289` · 5d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12284` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12279` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12276` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12269` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 `#12268` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 `#12265` · 6d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12263` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12257` · 6d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12253` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12249` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12245` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12239` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12231` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 `#12230` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#12229` · 7d — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 `#12228` · 7d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#12225` · 7d — producer output opened a PR that has not landed
  - chore(ops): session-reaper observations (auto)
- 🔔 `#11998` · 8d — producer output opened a PR that has not landed
  - chore(ops): trainer capture-watch receipt (auto)
- 🔔 `#11956` · 8d — producer output opened a PR that has not landed
  - chore(m28): valuation snapshots (auto)
- 🔔 `#11953` · 8d — producer output opened a PR that has not landed
  - chore(ops): refresh the error-feed digest (auto)
- 🔔 `#11952` · 8d — producer output opened a PR that has not landed
  - chore(ops): PR-queue watcher receipt (auto)
- 🔔 `#11943` · 8d — producer output opened a PR that has not landed
  - chore(ops): queue the daily work digest (auto)
- 🔔 `#11939` · 8d — producer output opened a PR that has not landed
  - chore(ops): refresh the A1 constraint readout (auto)
- 🔔 `#11919` · 8d — producer output opened a PR that has not landed
  - chore(ops): refresh probe results (auto)
- 🔔 `#11916` · 8d — producer output opened a PR that has not landed
  - chore(ml): replay pre-gate fleet report (auto)
- 🔔 `#11912` · 8d — producer output opened a PR that has not landed
  - chore(m7): strategy review packets (auto)

**`error_feed` — 11 due**

- `ERRFEED-72e2ad1e` · 6d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 70 rows 2026-09-14T10:02:36 → 2026-09-18T23:14:31 · accou…
...
- `ERRFEED-5402e495` · 4d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 47 rows 2026-09-16T23:54:03 → 2026-09-17T01:25:29 · accou…
...
- `ERRFEED-fa77ad80` · 8d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 24 rows 2026-09-12T18:12:44 → 2026-09-18T21:49:18 · symbo…
...
- `ERRFEED-9da85381` · 8d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 21 rows 2026-09-12T18:18:11 → 2026-09-18T04:51:30 · symbo…
...
- `ERRFEED-a46d2970` · 8d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 21 rows 2026-09-12T18:12:44 → 2026-09-20T06:06:30 · symbo…
...
- `ERRFEED-22c7c0be` · 4d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 14 rows 2026-09-16T19:29:11 → 2026-09-16T19:56:10 · accou…
...
- `ERRFEED-ae533209` · 7d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 9 rows 2026-09-13T14:15:14 → 2026-09-20T01:13:40 · accoun…
...
- `ERRFEED-6da04340` · 2d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 8 rows 2026-09-18T05:56:33 → 2026-09-20T06:06:30 · symbol…
...
- `ERRFEED-516a1b2a` · 6d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 8 rows 2026-09-14T06:10:03 → 2026-09-20T02:45:53 · accoun…
  - [error] x8 🔔 Broker close detected by reconciler Account: bybit_N Symbol: SOLUSDT | Side: short DB trade id: N Package: pkg-<hex> Reason: reconciler Cl
- `ERRFEED-c8553cf1` · 7d — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 7 rows 2026-09-13T08:38:35 → 2026-09-20T09:59:28 — decide…
...
- `ERROR-FEED-SUMMARY` — 50 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest ve…
  - 91 cause groups over 1387 rows (60 error-level, 31 warn-level, 0 new since the last digest)

**`sunset` — 12 due**

- `strategy:avax_pullback_2h` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · avax_pullback_2h
- `strategy:fade_breakout_4h` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · fade_breakout_4h
- `strategy:fvg_range_15m` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · fvg_range_15m
- `strategy:htf_pullback_trend_2h` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · htf_pullback_trend_2h
- `strategy:ief_pullback_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · ief_pullback_1d
- `strategy:iwm_trend_long_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · iwm_trend_long_1d
- `strategy:mhg_pullback_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · mhg_pullback_1d
- `strategy:qld_trend_long_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · qld_trend_long_1d
- `strategy:qqq_trend_long_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · qqq_trend_long_1d
- `strategy:slv_pullback_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · slv_pullback_1d
- `strategy:slv_trend_1h` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · slv_trend_1h
- `strategy:tlt_pullback_1d` · 19d — sunset pass proposed RETIRE (persistently_silent) and no disposition is recorded — Tier-3, so propose, never enact
  - strategy_leg · tlt_pullback_1d

**`checklist_unrouted` — 5 due**

- `MI-190-SPAWN-WITHOUT-SOURCE-URL-ATTACHES-THE-WRONG-REPO` · 1d — FILED AND NEVER ROUTED — 30.7h with owner `(no owner field)` and status `queued`, past the measured 24h threshold. Route it, disposition it…
  - Spawning without source_url can attach the WRONG repo, not merely no repo — and the 2026-09-06 row did not prevent it
- `MI-197-MERGE-SLOT-CARVE-OUT-DEADLOCK-HIT-TWICE-IN-ONE-MORNING` · 1d — FILED AND NEVER ROUTED — 30.7h with owner `unassigned` and status `queued`, past the measured 24h threshold. Route it, disposition it, or r…
...
- `MI-198-DUPLICATE-HELD-BY-KEY-PARSED-PAST-BY-EVERY-GUARD` · 1d — FILED AND NEVER ROUTED — 30.7h with owner `unassigned` and status `queued`, past the measured 24h threshold. Route it, disposition it, or r…
  - #11378 left a duplicate `held_by` inside merge_slot and every guard read straight past it
- `MI-290` · 1d — FILED AND NEVER ROUTED — 30.7h with owner `unassigned — needs a session; the operator asked for it to be QUEUED, not built ` and status `qu…
  - CANONIZE the session-receipt format — one shape for every session, and render it on the Workflow page
- `checklist-unrouted-standing` — The standing stock, carried as ONE row deliberately — the register names every id under `seeded_ids`/`reported_ids`. 76 have been said once…
  - 76 checklist row(s) unrouted past 24h, carried as a stock

**`stuck_branches` — 1 due**

- 🔔 `stuck-branches-changed` — automation/replay-pregate-35432513421-1. A stranded automation branch is a producer whose output never landed; a red check on a base that h…
  - 1 automation branch(es) newly stranded, 0 cleared

**`spent_decision_edges` — 11 due**
...
- 🔔 `spent-edge-WO-20260912-DECIDE-THE-LOUD-FLAG-TRIAGE` — Its `blocked_on` names DEC-20260912-LOUD-FLAG-TRIAGE, which carries a readable answer (date not recorded) — the edge has not been a blocker…
...
- 🔔 `spent-edge-WO-20260918-CAN-A-SCALP-CONTROL-BE-INDEPENDENT-AT-ALL` — Its `blocked_on` names DEC-20260918-BUILD-THE-UNDERDETERMINED-SCALP-CONTROL, which carries a readable answer (date not recorded) — the edge…
  - WO-20260918-CAN-A-SCALP-CONTROL-BE-INDEPENDENT-AT-ALL is `waiting` on an answered decision
- 🔔 `spent-edge-WO-20260918-DOES-THE-ICT-SCALP-HARNESS-FEED-THE-LIVE-DECISION-LIVE-INPUTS` — Its `blocked_on` names DEC-20260918-THE-ICT-SCALP-HARNESS-AND-THE-GATED-XRP-VARIANT, which carries a readable answer (date not recorded) —…
  - WO-20260918-DOES-THE-ICT-SCALP-HARNESS-FEED-THE-LIVE-DECISION-LIVE-INPUTS is `waiting` on an answered decision
- 🔔 `spent-edge-WO-20260918-IS-THE-FVG-HARNESS-A-VERBATIM-ENTRY-PORT` — Its `blocked_on` names DEC-20260918-FVG-DECLARED-CANDLE-MINIMUM, which carries a readable answer (date not recorded) — the edge has not bee…
  - WO-20260918-IS-THE-FVG-HARNESS-A-VERBATIM-ENTRY-PORT is `waiting` on an answered decision
- 🔔 `spent-edge-WO-20260918-WHICH-HARNESSES-RUN-THE-LIVE-ENTRY-DECISION` — Its `blocked_on` names DEC-20260918-WHERE-TO-SPEND-THE-NEXT-HARNESS-ADJUDICATION, which carries a readable answer (date not recorded) — the…
  - WO-20260918-WHICH-HARNESSES-RUN-THE-LIVE-ENTRY-DECISION is `waiting` on an answered decision
- 🔔 `spent-edge-WO-20260918-WHICH-LEGS-ARE-STARVED-AND-HOW-OFTEN` — Its `blocked_on` names DEC-20260918-UNSTARVE-THE-PROP-LEGS-OR-RECORD-THAT-WE-WILL-NOT, which carries a readable answer (date not recorded)…
  - WO-20260918-WHICH-LEGS-ARE-STARVED-AND-HOW-OFTEN is `waiting` on an answered decision

**`manager_queue_watch` — 1 due**

- 🔔 `manager-queue-watch-never-ran-overdue` · 17d — armed 429.3h ago, on the order of 429 expected firings, and ZERO receipts have ever been committed. The Routine reports SUCCEEDED, so nothi…
