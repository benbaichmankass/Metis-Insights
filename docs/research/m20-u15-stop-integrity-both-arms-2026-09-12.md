...
- **It does not establish that trailing is harmful.** A tightened stop that ends a trade may have saved a larger loss. `BL-20260908-A-TRAILING-AMEND-HAS-NO-DURABLE-RECORD-SO-ITS-RATE-IS-UNMEASURABLE` is why the rate cannot be audited at scale, and nothing here measures the counterfactual.
