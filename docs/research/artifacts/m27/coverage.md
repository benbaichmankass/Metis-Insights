...
|---|---|---|---|---|---|
| BTCUSDT | crypto | 1 | ✅ done (Phase-0 2026-07-20: gated leg LIVE; findings doc) | ❌ REJECT (P1 2026-07-22) — baseline 2/4 folds +3.71R exp +0.012, off-cells net-negative; 15m adds nothing over the live 5m gated leg. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
| ETHUSDT | crypto | 1 | ✅ P0 done — PASS w/ off-cells gate (kfold net: off_cells 3/4, +12.1R, exp +0.059; ungated baseline 3/4 +20.4R). Weakest passer; findings doc | ✅ PASS (P1 2026-07-22) — baseline 3/4 +23.28R; off-cells (single-axis) 4/4 +14.31R exp +0.142 (best). P4 candidate. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
| SOLUSDT | crypto | 1 | ✅ P0 done — STRONG PASS (kfold net: off_cells 4/4, +37.7R, exp +0.112; baseline 4/4 +62.7R even ungated). Findings doc | ✅ PASS (P1 2026-07-22) — baseline 3/4 +26.47R exp +0.075 (highest TotR); off-cells 2/4 +15.51R. P4 candidate. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
| XRPUSDT | crypto | 1 | ✅ P0 done — PASS, gate load-bearing (baseline only 2/4; off_cells 4/4 +34.3R exp +0.144; off+conf070 4/4 exp +0.255). Findings doc | ✅ **STRONG PASS** (P1 2026-07-22) — baseline **4/4** +20.66R AND off-cells 4/4 +15.89R exp +0.131; the most robust 15m cell. P4 candidate. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
| ADAUSDT | crypto | 1 | ⚠️ P0 done — MIXED: baseline 3/4 +55.1R exp +0.064 ungated, but the BTC-shape off-cells gate does NOT transfer (2/4, +3.9R). Needs own-evidence cells before any leg; findings doc | ❌ REJECT (P1 2026-07-22) — baseline 2/4 +4.54R exp +0.013, off-cells net-negative; mirrors the mixed 5m verdict. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
| AVAXUSDT | crypto | 1 | ✅ P0 done — PASS (baseline 4/4 +60.8R exp .065 ungated; off+conf070 4/4 +19.2R exp .160; plain off-cells 2/4 does not transfer). Findings doc | ⚠️ MARGINAL PASS (P1 2026-07-22) — baseline 3/4 +9.77R but thin exp +0.026; off-cells/calm 3/4. Watch/soak, not a confident promote. [findings](../../M27-P1-15m-findings-2026-07-22.md) | 📋 P1 |
