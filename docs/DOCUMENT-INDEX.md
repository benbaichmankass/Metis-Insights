...
| `docs/claude/work/BACKLOG-TRIAGE-2026-09-17.md` | evidence | live | — | 2026-09-17 | `not-assessed / read:MI-294-authored-it-this-session-triage-handoff` | the 21-class triage of the health backlog; supersedes nothing, hands a later session named chunks |
...
| `docs/claude/work/SYSTEM-REVIEW-2026-09-17.md` | evidence | live | — | 2026-09-17 | `not-assessed / read:MI-294-authored-it-this-session-review-record` | system review weighted to performance-7d and soak monitoring; states its own PARTIAL coverage against the /system-review schema |
