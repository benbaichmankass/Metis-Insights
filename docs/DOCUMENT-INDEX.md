...
| `evidence` | 348 | A measurement that may be CITED. True of its date and population. |
...
| `unknown` | 84 | **Could not be categorised. Not a category — the absence of one.** |
...
| `unknown` | 617 | NOBODY HAS CHECKED. Not a soft 'live'. The honest state, and a required one. |
...
that misled a manager. Measured across this population, **201 of 1044 documents
...
**Population: 1044 documents** — every file matching the git pathspecs
...
enter or leave the register). **1044 registered.**
