...
> (AI-scope canonical) and [`docs/ARCHITECTURE-CANONICAL.md`](../ARCHITECTURE-CANONICAL.md)
> (system-wide).
>
> **Companion docs:**
...
| `trade_outcomes` | 1 (data) | Realized trade results tied back to signals or execution intents | `src/units/`, `trade_journal.db` | `trade_journal.db::trades` (CLOSED, non-backtest) | per closed trade | outcome probability model (WS5) |
...
| `trade_outcomes` | ✅ | ⏳ | filed for a follow-up sprint |
