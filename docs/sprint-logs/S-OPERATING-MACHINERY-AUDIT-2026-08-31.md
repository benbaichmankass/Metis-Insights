...
- **Gaps not yet verified**:
  ...
  - The scope-overlap detector's three-state attribution is verified against the two live false positives it produced and against 35 self-test cases. It has **not** yet been observed firing on a genuine cross-session overlap.
