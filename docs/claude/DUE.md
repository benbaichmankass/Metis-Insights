...
_Generated 2026-09-07T20:46:32+00:00 · verdict **partial**_
...
- **ERRFEED-9fd2fc82** (error_feed · 14d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 54 rows 2026-08-24T23:19:48 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x54 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERRFEED-a46d2970** (error_feed · 5d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 24 rows 2026-09-02T02:03:23 → 2026-09-07T15:08:19 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
  - [error] x24 ⚠️ MONITOR BLIND — open position has no live dynamic exit Order package: pkg-<hex> Strategy: mhg_pullback_Nd | Symbol: MHG Reason: candles_u
...
- **ERRFEED-02a919f1** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 43 rows 2026-09-04T08:01:23 → 2026-09-07T19:51:46 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
  - [error] x43 🧱 Position CLOSE wedged BROKER-SIDE — carried in the digest Account: alpaca_paper Symbol: GLD | Side: long | Qty: N Consecutive close failur
- **ERRFEED-b3c9b0e2** (error_feed · 3d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 14 rows 2026-09-04T12:28:34 → 2026-09-07T16:18:01 · accounts=bybit_1 — decide: fix now, or file to a backlog
  - [error] x14 bybit_over_cover detected: bybit_N/ADAUSDT: position N. SAME-BOOK LEG OVER-ACCUMULATION: legs that REDUCE THIS position total N across N leg
...
- **ERROR-FEED-SUMMARY** (error_feed) — 73 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-07T10:41:39.779890+00:00`.
  - 122 cause groups over 1454 rows (83 error-level, 39 warn-level, 2 new since the last digest)
