...
_Generated 2026-09-06T17:20:44+00:00 · verdict **partial**_
...
- **ERRFEED-9fd2fc82** (error_feed · 13d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 72 rows 2026-08-24T19:27:41 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x72 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERROR-FEED-SUMMARY** (error_feed) — 70 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-06T14:02:20.751448+00:00`.
