...
_Generated 2026-09-10T10:01:02+00:00 · verdict **partial**_
...
- **ERRFEED-1ef305c7** (error_feed · 8d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 5 rows 2026-09-02T09:06:11 → 2026-09-06T00:32:43 · symbols=AVAXUSDT — decide: fix now, or file to a backlog
...
- **ERRFEED-a46d2970** (error_feed · 6d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 35 rows 2026-09-04T19:13:36 → 2026-09-10T05:45:10 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
...
- **ERRFEED-fa77ad80** (error_feed · 6d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 30 rows 2026-09-04T21:55:38 → 2026-09-10T05:45:09 · symbols=MES — decide: fix now, or file to a backlog
...
- **ERRFEED-f754bb5d** (error_feed · 2d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 16 rows 2026-09-08T19:22:45 → 2026-09-10T05:45:10 · symbols=MGC strategies=mgc_trend_1h — decide: fix now, or file to a backlog
...
- **ERROR-FEED-SUMMARY** (error_feed) — 58 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-10T05:10:31.853339+00:00`.
