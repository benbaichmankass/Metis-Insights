...
_Generated 2026-09-04T01:20:13+00:00 · verdict **partial**_
...
- 🔔 **PROBE-REPORT-STALE** (probes · 2d) — EVERY probe verdict below was observed at 2026-09-01T10:13:20.626767+00:00, NOT today. The probes job did not land a fresh report, so treat its rows as a record of that run and check the workflow.
  - probe report is 63.1h old — expected daily (cron 20 5 * * *)
...
- 🔔 **OI-20260831-PROP-RISK-GATE-ENFORCE-ARMED-BUT-HAS-NEVER-CAPPED** (probes) — probe FAILED — its declared observation did not hold [observed 2026-09-01T10:13:20.626767+00:00, 63.1h ago]
...
- 🔔 **OI-20260831-RESEARCH-QUEUE-INFEASIBLE-STATE-SHIPPED-BUT-NEVER-REACHED-LIVE** (probes) — probe FAILED — its declared observation did not hold [observed 2026-09-01T10:13:20.626767+00:00, 63.1h ago]
...
- **ERRFEED-3dedafaf** (error_feed · 12d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 7 rows 2026-08-23T08:07:50 → 2026-08-23T13:54:32 · accounts=ib_paper — decide: fix now, or file to a backlog
  - [error] x7 ib_target_naked detected: ib_paper/MES: position N has N of take-profit coverage against a declared TP of N — the position can only stop out
- **ERRFEED-9fd2fc82** (error_feed · 12d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 141 rows 2026-08-23T05:47:27 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x141 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERRFEED-6eb9d669** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 189 rows 2026-09-01T09:25:23 → 2026-09-02T08:17:06 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
...
- **ERRFEED-a46d2970** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 12 rows 2026-09-01T10:22:49 → 2026-09-04T00:15:45 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
...
- **ERRFEED-fa77ad80** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 11 rows 2026-09-01T16:16:52 → 2026-09-04T00:15:45 · symbols=MES — decide: fix now, or file to a backlog
...
- **OI-20260902-BYBIT-GRADED-COVERAGE-SOAK-IS-THE-ONLY-EVIDENCE-FOR-WIDENING-AND-NOTHING-WATCHES-IT** (soaks · 2d) — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: verdicts_differ=true. This is a KNOWN, DECLARED gap (`probe_absent_reason` says why) — it is NOT evidence the soak is empty, and it is not evidence it is accruing either. Nobody has looked.
  - #10746 ships a soak at runtime_logs/bybit_coverage_soak.jsonl whose rows are the ONLY declared evidence for the operator's conditional widening of the graded-coverage gate to bybit_portfolio and then 
- **ERROR-FEED-SUMMARY** (error_feed) — 61 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-03T22:16:21.717144+00:00`.
  - 102 cause groups over 1554 rows (71 error-level, 31 warn-level, 0 new since the last digest)
- **OI-20260826-STRAY-OCA-SWEEP-SHIPPED-BUT-UNARMED** (probes) — we did not look — this row is currently unwatched [observed 2026-09-01T10:13:20.626767+00:00, 63.1h ago]
  - probe could not run (exit_2)
- **OI-20260831-RESEARCH-QUEUE-GPU-ROUTE-AND-SPEND-GATE-NEVER-EXERCISED** (probes) — we did not look — this row is currently unwatched [observed 2026-09-01T10:13:20.626767+00:00, 63.1h ago]
  - probe could not run (exit_2)
- **OI-20260831-SESSION-BRIEF-DIFF-SCOPING-SHIPPED-NEVER-REPORTED-INHERITED** (probes) — we did not look — this row is currently unwatched [observed 2026-09-01T10:13:20.626767+00:00, 63.1h ago]
  - probe could not run (exit_2)
