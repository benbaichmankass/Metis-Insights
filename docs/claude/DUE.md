...
_Generated 2026-09-07T23:44:04+00:00 · verdict **partial**_
...
- 🔔 **OI-20260829-ALPACA-GOLIVE-BLOCKED-ON-T1-SETTLEMENT-MODEL** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260829-E35-REVERSED-LEGS-ARE-A-TIER-3-PROPOSAL-SET-NOT-APPLIED** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-LIVE-WALLET-TRUTH-CANNOT-REPRODUCE-THE-LEDGER-WINDOW** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-RESEARCH-QUEUE-GPU-ROUTE-AND-SPEND-GATE-NEVER-EXERCISED** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-RESEARCH-QUEUE-INFEASIBLE-STATE-SHIPPED-BUT-NEVER-REACHED-LIVE** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-SCOPE-OVERLAP-ATTRIBUTOR-MISREADS-A-SESSIONS-OWN-START** (open_items · 7d) — loud row — must be reported on every session
...
- 🔔 **OI-20260831-LOCAL-LLM-VERDICT-PENDING-A-DIFFERENT-SIZE-ARM** (open_items · 6d) — loud row — must be reported on every session
...
- 🔔 **OI-20260902-REAPER-SHIPPED-AND-THE-KILL-PROVED-A-PARTIAL-LOSS-NOT-A-CLEAN-ONE** (open_items · 5d) — loud row — must be reported on every session
...
- 🔔 **OI-20260903-OPERATOR-COMMANDS-MOVED-OFF-THE-TRADER-BOT-PREPARED-AND-HELD** (open_items · 4d) — monitoring row 4d since last observation (cadence 2d)
...
- 🔔 **OI-20260904-MANAGER-WAKE-BUILT-AND-ITS-SCHEDULER-DOES-NOT-EXIST** (open_items · 2d) — loud row — must be reported on every session
...
- 🔔 **OI-20260905-MI-128-SWEEP-WINDOW-REKEYED-AND-THE-PR-HOLDS-ON-A-BACKFILL-DECISION** (open_items · 2d) — loud row — must be reported on every session
...
- 🔔 **OI-20260906-BYBIT-CLOSE-QTY-SNAP-MERGED-BUT-NEVER-OBSERVED-ON-THE-FLEET** (open_items · 1d) — loud row — must be reported on every session
...
- 🔔 **OI-20260907-BE-FLOOR-R-IS-MEASURED-AND-REFUTED-AND-ITS-PR-IS-A-DRAFT-NOBODY-CAN-CLEAR** (open_items · 0d) — loud row — must be reported on every session
...
- 🔔 **OI-20260907-TELEMETRY-HOOK-IS-APPROVED-AND-GREEN-IN-AN-UNMERGED-PR-AND-OBSERVED-ON-NOTHING** (open_items · 0d) — loud row — must be reported on every session
...
- **ERRFEED-9fd2fc82** (error_feed · 13d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 53 rows 2026-08-25T00:00:40 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x53 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERRFEED-a46d2970** (error_feed · 5d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 25 rows 2026-09-02T02:03:23 → 2026-09-07T22:49:26 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
...
- **ERRFEED-fa77ad80** (error_feed · 5d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 20 rows 2026-09-02T02:03:23 → 2026-09-07T22:49:25 · symbols=MES — decide: fix now, or file to a backlog
...
- **OI-20260902-BYBIT-GRADED-COVERAGE-SOAK-IS-THE-ONLY-EVIDENCE-FOR-WIDENING-AND-NOTHING-WATCHES-IT** (soaks · 5d) — soak UNKNOWN — NO PROBE IS DECLARED for this soak, so nothing is reading it. Ready means: verdicts_differ=true. This is a KNOWN, DECLARED gap (`probe_absent_reason` says why) — it is NOT evidence the soak is empty, and it is not evidence it is accruing either. Nobody has looked.
  - #10746 ships a soak at runtime_logs/bybit_coverage_soak.jsonl whose rows are the ONLY declared evidence for the operator's conditional widening of the graded-coverage gate to bybit_portfolio and then 
- **ERRFEED-6da04340** (error_feed · 4d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 19 rows 2026-09-03T11:19:27 → 2026-09-07T22:49:25 · symbols=MGC strategies=mgc_pullback_1d — decide: fix now, or file to a backlog
  - [error] x19 ⚠️ MONITOR BLIND — open position has no live dynamic exit Order package: pkg-<hex> Strategy: mgc_pullback_Nd | Symbol: MGC Reason: candles_u
- **ERRFEED-02a919f1** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 55 rows 2026-09-04T08:01:23 → 2026-09-07T23:25:05 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
...
- **ERRFEED-b3c9b0e2** (error_feed · 3d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 15 rows 2026-09-04T12:28:34 → 2026-09-07T22:19:11 · accounts=bybit_1 — decide: fix now, or file to a backlog
  - [error] x15 bybit_over_cover detected: bybit_N/ADAUSDT: position N. SAME-BOOK LEG OVER-ACCUMULATION: legs that REDUCE THIS position total N across N leg
- **ERRFEED-b0711dd4** (error_feed · 0d) — error-level condition on `bot_logs`, FIRST SEEN since the last digest — 2 rows 2026-09-07T12:00:59 → 2026-09-07T18:04:36 · accounts=ib_paper — decide: fix now, or file to a backlog
  - [error] NEW x2 ib_stop_over_cover detected: ib_paper/MGC: position N but resting STOP qty totals N (N%) across N DISJOINT OCA groups oca-protect-tN(clientI
- **ERRFEED-cf5a4edf** (error_feed · 0d) — error-level condition on `bot_logs`, FIRST SEEN since the last digest — 1 rows 2026-09-07T11:49:36 → 2026-09-07T11:49:36 · accounts=ib_paper — decide: fix now, or file to a backlog
...
- **ERROR-FEED-SUMMARY** (error_feed) — 73 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-07T10:41:39.779890+00:00`.
  - 122 cause groups over 1470 rows (83 error-level, 39 warn-level, 2 new since the last digest)
