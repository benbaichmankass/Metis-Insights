...
_Generated 2026-09-07T16:38:58+00:00 · verdict **partial**_
...
- **ERRFEED-9fd2fc82** (error_feed · 14d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 55 rows 2026-08-24T23:09:40 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x55 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERRFEED-02a919f1** (error_feed · 3d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 30 rows 2026-09-04T08:01:23 → 2026-09-07T16:32:12 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
  - [error] x30 🧱 Position CLOSE wedged BROKER-SIDE — carried in the digest Account: alpaca_paper Symbol: GLD | Side: long | Qty: N Consecutive close failur
...
- **ERRFEED-b0711dd4** (error_feed · 0d) — error-level condition on `bot_logs`, FIRST SEEN since the last digest — 1 rows 2026-09-07T12:00:59 → 2026-09-07T12:00:59 · accounts=ib_paper — decide: fix now, or file to a backlog
...
- **ERROR-FEED-SUMMARY** (error_feed) — 73 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-07T10:41:39.779890+00:00`.
  - 122 cause groups over 1441 rows (83 error-level, 39 warn-level, 2 new since the last digest)
