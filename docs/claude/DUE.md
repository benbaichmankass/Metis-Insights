...
_Generated 2026-09-08T14:45:26+00:00 · verdict **partial**_
...
- **ERRFEED-9fd2fc82** (error_feed · 14d) — error-level condition on `bot_logs`, STANDING (predates the last digest) — 39 rows 2026-08-25T06:05:52 → 2026-08-25T22:48:45 · symbols=MGC strategies=ict_scalp_mgc_15m — decide: fix now, or file to a backlog
  - [error] x39 strategy_builder exception: RuntimeError: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
...
- **ERRFEED-86505576** (error_feed · 6d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 183 rows 2026-09-02T08:33:53 → 2026-09-08T14:40:50 · accounts=alpaca_paper symbols=GLD — decide: fix now, or file to a backlog
  - [error] x183 🛑 Position CLOSE failing — won't flatten Account: alpaca_paper Symbol: GLD | Side: long | Qty: N Consecutive close failures: N share_hold: o
- **ERRFEED-a46d2970** (error_feed · 6d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 32 rows 2026-09-02T02:03:23 → 2026-09-08T14:16:09 · symbols=MHG strategies=mhg_pullback_1d — decide: fix now, or file to a backlog
...
- **ERRFEED-fa77ad80** (error_feed · 6d) — error-level condition on `operator_alerts`, STANDING (predates the last digest) — 27 rows 2026-09-02T02:03:23 → 2026-09-08T14:15:39 · symbols=MES — decide: fix now, or file to a backlog
  - [error] x27 ⚠️ MONITOR BLIND — open position has no live dynamic exit Order package: pkg-<hex> Strategy: mes_trend_long_Nd | Symbol: MES Reason: candles
...
- **ERROR-FEED-SUMMARY** (error_feed) — 79 further error group(s) and every warn group are NOT listed above — read `docs/claude/ERROR-FEED-DIGEST.json` for the full set. Digest verdict `all_feeds_read`, page cap hit on `bot_logs`, covers rows after `2026-09-08T05:07:41.352880+00:00`.
  - 128 cause groups over 1554 rows (89 error-level, 39 warn-level, 4 new since the last digest)
