...
_Generated 2026-09-14T01:36:02+00:00 · covers rows after `2026-09-13T04:13:49.648924+00:00` · verdict **all_feeds_read**_

> ⚠️ **Page cap hit** on `bot_logs` — older rows exist that this digest did not see.

## Population

- **operator_alerts** — state `read` · 356 of 1000 requested · span 2026-09-09T06:44:24.244346+00:00 → 2026-09-14T01:22:49.384594+00:00
- **bot_logs** — state `read` · 1000 of 1000 requested · span 2026-09-12T09:03:19.916230+00:00 → 2026-09-14T01:22:20.995707+00:00

## Groups (70, covering 1356 rows)
...
- **[error] x62** `operator_alerts` — ⚠️ MONITOR BLIND — open position has no live dynamic exit Order package: pkg-<hex> Strategy: ict_scalp_mgc_Nm | Symbol: MGC Reason: candles_unavailable (for N c
  - 2026-09-10T09:07:19.410872+00:00 → 2026-09-14T01:22:49.075432+00:00 · symbols: MGC · strategies: ict_scalp_mgc_15m
- **[error] x53** `operator_alerts` — ⚠️ MONITOR BLIND — open position has no live dynamic exit Order package: pkg-<hex> Strategy: mes_trend_long_Nd | Symbol: MES Reason: candles_unavailable (for N 
  - 2026-09-09T16:16:17.159897+00:00 → 2026-09-14T01:22:49.384594+00:00 · symbols: MES
...
- **[error] x4** `operator_alerts` — 🔔 Broker close detected by reconciler Account: bybit_N Symbol: AVAXUSDT | Side: long DB trade id: N Package: pkg-<hex> Reason: reconciler Classification: broker
  - 2026-09-10T07:23:53.005707+00:00 → 2026-09-14T00:31:07.738599+00:00 · accounts: bybit_1 · symbols: AVAXUSDT
...
- **[warn] x197** `bot_logs` — position_read_state hedge_book_dropped
  - 2026-09-12T09:03:19.916230+00:00 → 2026-09-12T11:05:29.593930+00:00
- **[warn] x170** `bot_logs` — strategy_builder exception: transient_market_data_unavailable: ict_scalp_mgc_Nm: no candle data for symbol=MGC timeframe=Nm.
  - 2026-09-12T09:04:44.608441+00:00 → 2026-09-14T01:22:17.544545+00:00 · symbols: MGC · strategies: ict_scalp_mgc_15m
- **[warn] x165** `bot_logs` — strategy_builder exception: transient_market_data_unavailable: mgc_trend_Nh: no candle data returned for symbol=MGC timeframe=Nh. Check that the IBKR connection
  - 2026-09-12T09:04:45.553053+00:00 → 2026-09-14T01:22:18.344355+00:00 · symbols: MGC · strategies: mgc_trend_1h
- **[warn] x162** `bot_logs` — strategy_builder exception: transient_market_data_unavailable: mgc_pullback_Nd: no candle data returned for symbol=MGC timeframe=Nd. Check that the IBKR connect
  - 2026-09-12T09:04:45.082439+00:00 → 2026-09-14T01:22:17.934903+00:00 · symbols: MGC · strategies: mgc_pullback_1d
- **[warn] x153** `bot_logs` — strategy_builder exception: transient_market_data_unavailable: mes_trend_long_Nd: no candle data returned for symbol=MES timeframe=Nd. Check that the IBKR conne
  - 2026-09-12T09:04:42.316703+00:00 → 2026-09-14T01:22:15.919194+00:00 · symbols: MES
- **[warn] x152** `bot_logs` — strategy_builder exception: transient_market_data_unavailable: mhg_pullback_Nd: no candle data returned for symbol=MHG timeframe=Nd. Check that the IBKR connect
  - 2026-09-12T09:04:47.750238+00:00 → 2026-09-14T01:22:20.995707+00:00 · symbols: MHG · strategies: mhg_pullback_1d
- **[warn] x8** `operator_alerts` — 🔎 Stuck-strategy watchdog (informational — no action) Strategy: ict_scalp_avax_Nm | Symbol: AVAXUSDT Package: pkg-<hex> DB trade id: N Held for: N min (≥ N× its
  - 2026-09-10T10:09:23.612270+00:00 → 2026-09-14T01:10:30.965282+00:00 · symbols: AVAXUSDT · strategies: ict_scalp_avax_5m
- **[warn] x7** `operator_alerts` — 🔎 Stuck-strategy watchdog (informational — no action) Strategy: pairs_bnb_btc_a | Symbol: BNBUSDT Package: pkg-<hex> DB trade id: N Held for: N min (≥ N× its ti
  - 2026-09-09T17:01:27.636417+00:00 → 2026-09-13T22:03:50.277003+00:00 · symbols: BNBUSDT · strategies: pairs_bnb_btc_a
- **[warn] x7** `operator_alerts` — 🔎 Stuck-strategy watchdog (informational — no action) Strategy: pairs_bnb_btc_b | Symbol: BTCUSDT Package: pkg-<hex> DB trade id: N Held for: N min (≥ N× its ti
  - 2026-09-09T17:01:27.628546+00:00 → 2026-09-13T22:03:50.269674+00:00 · symbols: BTCUSDT · strategies: pairs_bnb_btc_b
...
- **[warn] x3** `operator_alerts` — 🔎 Stuck-strategy watchdog (informational — no action) Strategy: ict_scalp_sol_Nm | Symbol: SOLUSDT Package: pkg-<hex> DB trade id: N Held for: N min (≥ N× its t
  - 2026-09-11T10:30:59.936370+00:00 → 2026-09-13T23:04:07.958580+00:00 · symbols: SOLUSDT · strategies: ict_scalp_sol_15m
...
_Watermark: `2026-09-14T01:22:49.384594+00:00` — advanced to the newest row read (2026-09-14T01:22:49.384594+00:00)_
