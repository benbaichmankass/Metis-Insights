...
| `NEWS_ENABLED` | Master gate for the **M9 news layer** (`src/news/`). Truthy → the pipeline news hook is live. Default off. Per-symbol queries/keywords live in `config/news_symbols.yaml`; full reference in `docs/news_layer.md`. |
